    ...
    <table width="100" height="249" border="0" align="center">
        <tr>
            <td align="center" valign="middle">
                <form name="form1" method="post" action="">
                    <label>
                        <button id="w 20" type="button" onclick="buttonclick(this);" class="button red">Claw_Close</button>
                    </label>
                </form>
            </td>
            <td align="center" valign="middle">
            ...
            <td align="center" valign="middle">
                <form name="form1" method="post" action="">
                    <label>
                        <button id="w 21" type="button" onclick="buttonclick(this);" class="button red">Claw_Open</button>
                    </label>
                </form>
            </td>
        </tr>
        ...
        <tr>
            <td align="center" valign="middle">
                <form name="form1" method="post" action="">
                    <label>
                        <button id="w 0 0" type="button" onclick="buttonclick(this);" class="button yellow">Walk</button>
                    </label>
                </form>
            </td>
            <td align="center" valign="middle">
            ...
            <td align="center" valign="middle">
                <form name="form1" method="post" action="">
                    <label>
                        <button id="w 7 1" type="button" onclick="buttonclick(this);" class="button yellow">Run</button>
                    </label>
                </form>
            </td>
        </tr>
